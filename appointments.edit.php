	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2><i class="glyphicon glyphicon-edit"></i> Edit Appointment</h2>
				<div class="box-icon">
     ...
     <form>
        ...
        Date: <input type="date" class="form-control" value="2015/04/14">
        Time: <input type="time" class="form-control" value="12PM">
        Location: <input type="text" class="form-control" value="Scanning room">
        Reason for Appointment: <input type="text" class="form-control" value="MRI scan">
        </p></div>
        <input class="btn btn-primary" type="submit" value="Update Appointment">
    </form>
    		</div>
    	</div>
    </div>	
